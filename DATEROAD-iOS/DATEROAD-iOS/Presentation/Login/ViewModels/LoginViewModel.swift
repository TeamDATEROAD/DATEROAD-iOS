...
extension LoginViewModel {
    ...
    func loginWithApple(userInfo: ASAuthorizationAppleIDCredential) {
        ...
        UserDefaultsManager.shared.authCode = authCode
    ...
    func setToken(token: String) {
        guard let socialType = self.socialType.value else { return }
        UserDefaultsManager.shared.platform = socialType.rawValue
        UserDefaultsManager.shared.socialToken = token
    ...
    func postSignIn() {
        ...
        let requestBody = PostSignInRequest(platform: UserDefaultsManager.shared.platform)
