...
extension CourseDetailView {
    ...
    func createCompositioinalLayout() -> UICollectionViewCompositionalLayout {
        return UICollectionViewCompositionalLayout { section, _ -> NSCollectionLayoutSection? in
            ...
            case .imageCarousel:
                return self.createLayout(widthDimension: .fractionalWidth(1), heightDimension: .fractionalWidth(1), itemHeight: .fractionalHeight(1), orthogonalBehavior: .groupPaging, supplementaryItems: [self.makeGradientView(), self.makeBottomPageControllView()], itemInsets: NSDirectionalEdgeInsets(top: 0, leading: 0, bottom: 23, trailing: 0))
            case .titleInfo:
                return self.createLayout(widthDimension: .fractionalWidth(1), heightDimension: .estimated(160), itemHeight: .estimated(160),supplementaryItems: [self.makeInfoBarView(), self.makeVisitDateView()], itemInsets: NSDirectionalEdgeInsets(top: 0, leading: 16, bottom: 0, trailing: 16))
            case .mainContents:
                return self.createLayout(widthDimension: .fractionalWidth(1), heightDimension: .estimated(50), itemHeight: .estimated(50), supplementaryItems: !self.isAccess ? [self.makeContentMaskView()] : nil, itemInsets: NSDirectionalEdgeInsets(top: 0, leading: 16, bottom: 0, trailing: 16))
            case .timelineInfo:
                return self.createLayout(widthDimension: .fractionalWidth(1), heightDimension: .estimated(70), itemHeight: .estimated(70), supplementaryItems: [self.makeTimelineHeaderView()], sectionInsets: NSDirectionalEdgeInsets(top: 0, leading: 0, bottom: 15, trailing: 0), itemInsets: NSDirectionalEdgeInsets(top: 0, leading: 16, bottom: 0, trailing: 16))
            case .coastInfo:
