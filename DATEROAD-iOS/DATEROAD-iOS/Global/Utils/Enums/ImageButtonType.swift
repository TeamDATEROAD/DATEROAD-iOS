...
enum ImageButtonType {
    ...
    case deepPurple_white_15, deepPurple_white_14
    
    case gray100_gray300_14
    
    case white_gray600_0, white_gray400_0, white_gray300_0
    
    case clear_white_25, clear_mediumPurple_0, clear_black_0, clear_gray400_0,
         clear_clear_16, clear_clear_8, clear_clear_0, clear_white_0
    ...
    var tintColor: UIColor {
        ...
        case .clear_white_25, .deepPurple_white_15, .deepPurple_white_14, .clear_white_0:
            return UIColor(resource: .drWhite)
